...
func (ec *executionContext) field_Mutation_createDish_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNcreateDishInput2quickeatᚋpkgᚋgraphqlᚋmodelsᚐCreateDishInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Dish_category(ctx context.Context, field graphql.CollectedField, obj *models.Dish) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOCategory2ᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐCategory(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_category(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*models.Category)
	fc.Result = res
	return ec.marshalOCategory2ᚕᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐCategoryᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNCategory2ᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐCategory(ctx context.Context, sel ast.SelectionSet, v *models.Category) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOCategory2ᚕᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐCategoryᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Category) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCategory2ᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐCategory(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalODish2ᚕᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐDishᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Dish) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDish2ᚖquickeatᚋpkgᚋgraphqlᚋmodelsᚐDish(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
